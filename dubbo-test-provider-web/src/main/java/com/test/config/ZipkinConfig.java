...
public class ZipkinConfig extends PropertyPlaceholderConfigurer {
	...
	protected void processProperties(ConfigurableListableBeanFactory beanFactoryToProcess, Properties props)
		...
		for (Object key : props.keySet()) {
			String keyStr = key.toString();   //获取config.properties文件中的配置信息  如：key  http.sender.address
			String value = props.getProperty(keyStr); // value  http://127.0.0.1:9411/api/v1/spans
	...
	public static String getProperty(String key) {
		return getProperty(key, "");    //调用getProperty()方法  获取property文件中key对应的value值
	}
