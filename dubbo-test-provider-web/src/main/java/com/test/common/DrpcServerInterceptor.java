...
import com.test.config.ZipkinConfig;
import com.test.constant.ZipkinConstants;
...
public class DrpcServerInterceptor implements Filter{
	...
	static final class DrpcServerRequestAdapter implements ServerRequestAdapter {
        ...
        public String getSpanName() {
        	User ls = (User) invocation.getArguments()[0];
             String serviceName = ls == null || ls.getServiceName() == null?"unkown":ls.getServiceName();
             return serviceName;
        }
